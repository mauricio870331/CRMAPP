        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Historial Pagos de Afiliados || <input type="button" id="backInicio" class="btn btn-success"  value="Regresar">                      
                    </h1>                    
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="col-xs-3" style="display: inline-flex;margin-left: 70%;margin-top: -4.4%"> 
                                ...
                                <span class="input-group-btn">
                                    <button type="button" id="findPayment" class="btn btn-primary btn-flat">Buscar</button>
                                </span>
                            </div>
                        </div>
