        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Notificaciones <?php echo (base64_decode($_GET['token']) == "PENDIENTE") ? "Pendientes" : "Ejecutadas"; ?> || <input type="button" id="backInicio" data-view="admin" class="btn btn-success"  value="Regresar">
                    </h1>                    
                </section>
