        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Listado de Leads || <input type="button" id="backInicio" data-view="admin" class="btn btn-success"  value="Regresar">
                    </h1>                    
                </section>
                        ...
                        <div class="col-xs-12">                   
                            ...
                            <div class="box">                               
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="modal fade" id="modal-setClient">
                                        <div class="modal-dialog">
                                            <div class="modal-content" style="width: 60%;margin-left: 28%">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                ...
                                                <div class="modal-body">
                                                    <p>Esta seguro de convertir este lead en cliente?</p>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button"  class="btn btn-default pull-left" data-dismiss="modal">Cerrar</button>
                                                    <button type="button" id="setClient" data-id="" data-opc=""  class="btn btn-primary">Guardar</button>
                                                </div>
                                            </div>
                                            <!-- /.modal-content -->
                                        </div>
