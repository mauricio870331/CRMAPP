        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Crear Nuevo R || GPS <input type="button" id="cancelarR" class="btn btn-success"  value="Cancelar">                       
                    </h1>                   
                </section>
                            ...
                            <div class="box box-primary">
                                ...
                                <form role="form">
                                    <div class="box-body">  
                                        ...
                                        <div class="form-group">
                                            <label for="R">*Codigo</label>
                                            <input type="text" class="form-control" disabled id="R2" placeholder="Ingrese R">
                                        </div>  
                                    </div>
                                    <!-- /.box-body -->

                                    <div class="box-footer">                                      
                                        <button type="button" id="CrearNewR" class="btn btn-primary">Guardar</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content" style="width: 117%;">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" id="deleteVehiculo" data-id="" data-estado="" class="btn btn-primary">Activar / Descativar</button>
                                </div>
                            </div>
                            <!-- /.modal-content -->
                        </div>
