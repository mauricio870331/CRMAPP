        ...
        <td>
            ...
            <div class="col-md-3 col-sm-4" style="margin-right: -5%;">
                <?php if ($value['estado'] == "ACTIVO") { ?>
                    <i class="fa fa-fw fa-eraser deleteLead" style="cursor: pointer" data-option="SUSPENDIDO" data-id="<?php echo $value['id']; ?>" data-toggle="tooltip" title="Borrar"></i>
                <?php } else { ?>
                    <i class="fa fa-fw fa-check deleteLead" style="cursor: pointer" data-option="ACTIVO" data-id="<?php echo $value['id']; ?>" data-toggle="tooltip" title="Activar"></i>
                <?php } ?>
