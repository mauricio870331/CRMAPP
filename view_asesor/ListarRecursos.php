...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <!-- Header -->
            <?php include_once './HeaderAsesor.php'; ?>
            <!-- =============================================== -->
            <!-- Left side column. contains the logo and sidebar -->
            <!-- Menu -->
            <?php include_once './MenuAsesor.php'; ?>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Listado de Usuarios || <input type="button" id="backInicio" data-view="asesor" class="btn btn-success"  value="Regresar">
                    </h1>                    
                </section>
