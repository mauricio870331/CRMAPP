...
$SQL_SELECT_LEAD = "SELECT count(*) total_leads FROM personas u "
        ...
        . "and u.asesor = " . $_SESSION['obj_user'][0]['id'];
...
$SQL_SUM_TRANFER = "select  COALESCE(sum(pp.valor_cuota), 0) total from pagos_producto pp "
        ...
        . "where pp.creado_por = " . $_SESSION['obj_user'][0]['id'];
...
$SQL_SUM_TOT_VENT = "select COALESCE(sum(valor_cuota), 0) total from pagos_producto "
        ...
        . "and creado_por = " . $_SESSION['obj_user'][0]['id'];
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <form role="form">
                                                    <div class="box-body">
                                                        ...
                                                        <input type="hidden" value="<?php echo $_SESSION['obj_user'][0]['id']; ?>"  name="asesor" id="asesor" />
