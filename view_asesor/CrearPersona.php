        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Crear Leads || <input type="button" id="backCrearUsuarios" class="btn btn-success"  value="Cancelar">                       
                    </h1>                   
                </section>
                                ...
                                <form role="form">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="pwd" placeholder="Ingrese Contraseña">
                                        </div>
                                        <div class="form-group">
