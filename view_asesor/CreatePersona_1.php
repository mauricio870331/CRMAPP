...
//                                                        print_r($list);
                                                        for ($index = 0; $index < count($list); $index++) {
                                                            ?>
                                                            <option value="<?php echo $list[$index]['tipo_doc']; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="apellidos" class="form-control col-md-7 col-xs-12" type="text" name="apellidos">
                                                </div>
                                            </div>    
                                            <div class="form-group">
                                                <label for="telefonos" class="control-label col-md-3 col-sm-3 col-xs-12">Telefonos</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="telefonos" class="form-control col-md-7 col-xs-12" type="text" name="telefonos">
                                                </div>
                                            </div> 
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="ss" class="form-control col-md-7 col-xs-12" type="text" name="ss">
                                                </div>
                                            </div>                                            
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class='col-md-6 col-sm-6 col-xs-12'>                                            
                                                    <div class='input-group date' id='myDatepicker2'>
                                                        <input id="cita" name="cita" type='text' class="form-control" />
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                    ...
                                                    <button type="button" id="send" onclick="sendPerson('add')" class="btn btn-success">Guardar</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
